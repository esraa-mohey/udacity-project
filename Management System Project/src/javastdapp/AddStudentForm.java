...
public class AddStudentForm extends javax.swing.JFrame {
    ...
    private void button_Add1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button_Add1ActionPerformed
        ...
        try{
              mangStudent.jTable1.setModel(new DefaultTableModel(null,new Object[]{"Id","First Name","Last Name","Sex","Phone","Address"}));       
             std.Fill_Student_Table(mangStudent.jTable1, "");
        }catch(Exception ex)
        {
