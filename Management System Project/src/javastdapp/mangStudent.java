 ...
 * @author HP
 */
public class mangStudent extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jRadioButton_male.setBackground(new java.awt.Color(153, 153, 255));
        jRadioButton_male.setForeground(new java.awt.Color(255, 255, 255));
        jRadioButton_male.setText("Male");

        jRadioButton_female.setBackground(new java.awt.Color(153, 153, 255));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(mangStudent.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new mangStudent().setVisible(true);
            }
        });
    }
